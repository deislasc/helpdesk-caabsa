...
<div class="login-page row login-only">    
                  ...
                  <div class="col-md-6">
                      ...
                      <ul class="list-unstyled" style="line-height: 2">
                          <li><span class="fa fa-check text-success"></span> <?php echo __('No tienes cuenta corporativa de Google?'); ?> <a href="account.php?do=create"><?php echo __('Crea una cuenta para empezar a generar tus tickets'); ?></a></li>
    ...
    ?></li> -->
                ...
                <form action="login.php" method="post" id="clientLogin" class="form-horizontal">
                    ...
                    <div style="margin-bottom: 25px" class="input-group">
                        ...
                        <input class="btn btn-lg btn-primary btn-block" type="submit" value="<?php echo __('Ingresar'); ?>">
