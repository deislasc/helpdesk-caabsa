...
<?php if (!isset($_SESSION['_client']['reset-token'])) { ?>
 <div class="form-group"> 
        ...
        <div class="col-sm-10"><input class="form-control" type="password" size="18" name="cpasswd" maxlength="128" value="<?php echo $info['cpasswd']; ?>">
...
<?php } ?>
 <div class="form-group"> 
       ...
       <div class="col-sm-10"> <input class="form-control" type="password" size="18" name="passwd1" maxlength="128" value="<?php echo $info['passwd1']; ?>">
 ...
 <div class="form-group"> 
       ...
       <div class="col-sm-10"> <input class="form-control" type="password" size="18" name="passwd2" maxlength="128" value="<?php echo $info['passwd2']; ?>">
