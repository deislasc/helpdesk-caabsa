    ...
    <div class="row front-boxes">  
        <div class="col-xs-12 col-sm-12 col-lg-12">
            <div class="row bgcolor">
                ...
                <div class="col-xs-12 col-sm-6 col-lg-4 text-justify box2">
                    <div class="icon">
                        <div class="image"><img src="<?php echo ASSETS_PATH; ?>images/new_ticket_icon.png" alt="<?php echo __('Open a New Ticket') ?>" style="width:65px;"></div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-lg-4 text-justify box2">
                    <div class="icon">
                        <div class="image"><img src="<?php echo ASSETS_PATH; ?>images/check_status_icon.png" alt="<?php echo __('Check Ticket Status') ?>" style="width:65px;"></div>
                    </div>
